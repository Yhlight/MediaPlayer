...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (VideoWidget::*)(const QStringList & );
            if (_q_method_type _q_method = &VideoWidget::filesDropped; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoWidget::filesDropped(const QStringList & _t1)
{
